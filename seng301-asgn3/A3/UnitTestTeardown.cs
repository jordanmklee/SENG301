...
namespace A3
{
	// This test class tests the teardown function
	[TestClass]
	public class UnitTestTeardown
	{
		...
		[TestMethod]
		public void T03_good_teardown()
		{
			// Tests the teardown of a vending machine
		...
		[TestMethod]
		public void T12_credit_change()
		{
			// Tests leftover coins from previous teardown
			List<VendingMachine> vendingList = new List<VendingMachine>();
